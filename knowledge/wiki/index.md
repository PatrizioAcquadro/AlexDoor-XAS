...
- [[implementation_phases/phase-5-door-corpus-and-qualification|Phase 5 — Door Corpus and Qualification]] — Verified preparation with reviewed graphics-asset repairs; two real doors ready (one local-only), expert qualification pending.
